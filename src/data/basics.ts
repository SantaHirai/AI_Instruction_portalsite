...
export const usageExamples: UsageExampleItem[] = [
    {
        ...
        items: [
            ...
            {
                title: 'メールの自動仕分け',
                description: '迷惑メールを自動でフォルダ分けしたり、内容を判断して仕分けを行います。'
            },
            {
                title: '自動運転車',
...
export const safetyRules: SafetyRuleItem[] = [
    ...
    },
    {
        id: 6,
        title: '差別的・攻撃的な内容',
        description: '悪口や暴力的な内容を入力してはいけません。社会的な問題になり、自身の信用を傷つけることになります。社会に公開されても問題のないような指示をしましょう。'
    },
    {
        id: 7,
        title: '第三者に関する情報',
        description: '第三者の写真や住所などの個人情報も絶対に入力しないでください。自分の情報ではないからと言って、AIに入力をしていいわけではありません。'
    },
    {
        id: 8,
        title: '感情的な深い相談',
