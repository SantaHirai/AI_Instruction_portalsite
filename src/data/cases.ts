...
export const cases: CaseItem[] = [
    {
        ...
        prompt: {
            ...
            aiResponse: `はい、20分以内で作れる大根と豚肉のレシピを3つ提案します。<br/><br/>1. **豚バラ大根の甘辛炒め**<br/>薄切りの大根と豚肉を炒め、醤油・砂糖・みりんで味付けます。大根を薄く切ることで火の通りを早くするのがポイントです。<br/><br/>2. **大根と豚こまのオイスターソース煮**<br/>レンジで少し柔らかくした大根と豚肉を炒め、オイスターソースでコクを出します。<br/><br/>3. **豚しゃぶと大根のサラダ風**<br/>千切りにした大根と茹でた豚肉を、ポン酢とごま油で和えるだけのさっぱりメニューです。`
        }
    },
    {
        id: 'travel',
        ...
        prompt: {
            ...
            aiResponse: `ゆったり楽しめる1泊2日の京都プランをご提案します。<br/><br/>**1日目：東山エリア（清水寺周辺）**<br/>・午後：京都駅到着後、タクシーで**清水寺**へ。参拝後、産寧坂・二年坂をゆっくり散策。<br/>・夕方：高台寺周辺で早めの夕食。風情ある街並みを楽しめます。<br/><br/>**2日目：嵐山エリア**<br/>・午前：**嵐山**へ移動（移動はタクシーが楽でおすすめです）。竹林の小径を散歩。<br/>・昼食：渡月橋を眺めながら京料理。<br/>・午後：天龍寺の庭園を鑑賞し、お土産を買って京都駅へ。<br/><br/>移動の負担を減らすため、エリアを絞って詰め込みすぎない行程にしました。`
        }
    },
    {
        id: 'writing',
        ...
        prompt: {
            ...
            aiResponse: `ご近所の皆様へ<br/><br/>いつも町内会の活動にご協力いただき、ありがとうございます。<br/>さて、気持ちの良い季節となりましたが、恒例の「町内一斉清掃」を下記の日程で行います。<br/><br/>**日時：** 〇月〇日（土） 午前9時～（1時間程度）<br/>**集合場所：** 〇〇公園<br/>※雨天の場合は中止となります。<br/><br/>ご近所の皆様と顔を合わせながら、無理のない範囲で街をきれいにできればと思います。<br/>お忙しいところ恐れ入りますが、ご参加をお待ちしております。`
        }
    }
];
